...
modulation_indx1_rs = (WN1(rs1,1) -WN2(rs1,4))./(WN2(rs1,1) + WN2(rs1,4)); %running
modulation_indx2_rs = (WN2(rs2,2) -WN2(rs2,3))./(WN2(rs2,2) + WN2(rs2,3)); %large pupil + sit
modulation_indx1_fs = (WN2(fs2,1) -WN2(fs2,4))./(WN2(fs2,1) + WN2(fs2,4)); %running
modulation_indx2_fs = (WN2(fs2,2) -WN2(fs2,3))./(WN2(fs2,2) + WN2(fs2,3)); %large pupil + sit
...
modulation_indx1_rsL = (WN2L(rs2,1) -WN2L(rs2,4))./(WN2L(rs2,1) + WN2L(rs2,4)); %running
modulation_indx2_rsL = (WN2L(rs2,2) -WN2L(rs2,3))./(WN2L(rs2,2) + WN2L(rs2,3)); %large pupil + sit
modulation_indx1_fsL = (WN2L(fs2,1) -WN2L(fs2,4))./(WN2L(fs2,1) + WN2L(fs2,4)); %running
modulation_indx2_fsL = (WN2L(fs2,2) -WN2L(fs2,3))./(WN2L(fs2,2) + WN2L(fs2,3)); %large pupil + sit
