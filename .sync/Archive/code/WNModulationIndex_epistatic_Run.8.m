...
rs2 = Rs(evoked2);
recs2 = recs(evoked2); cells2 = cells(evoked2);
WN2 = meanWN(evoked2,1:2);
WN2L = meanWNL(evoked2,1:2);
SP2 = SP(evoked2,:);
SP2L = SPL(evoked2,:);
...
modulation_indx1 = (WN2(:,1) -WN2(:,4))./(WN1(:,1) + WN2(:,4)); %running
modulation_indx1_sp= (SP2(:,1) -SP1(:,4))./(SP1(:,1) + SP1(:,4));
