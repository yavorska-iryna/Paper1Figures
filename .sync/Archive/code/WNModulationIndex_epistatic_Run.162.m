...
title(title_str)
 ...
 meanMI_sound_laser = nanmean(WN1L(:))
figure;
errorbar([1 2], [ mean([meanMI_sound_sitL; meanMI_sound_runL]) mean([meanMI_sound_sit; meanMI_sound_run])], [mean([semMI_sound_sitL; semMI_sound_runL])
