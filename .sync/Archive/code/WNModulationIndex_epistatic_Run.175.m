...
semMI_sound_laser = nansem( nanmean([MI_sound_run_laser MI_sound_sit_laser],2));

meanMI_sound_laser = nanmean( nanmean([MI_sound_run MI_sound_sit],2));
semMI_sound_laser = nansem( nanmean([MI_sound_run MI_sound_sit],2));
