...
modulation_indx1Laser = (nanmean(WN1L(:,:),2) - nanmean(WN1(:,:),2))./(nanmean(WN1L(:,:),2) + nanmean(WN1(:,:),2)); % effect of layer in this layer across states
...
modulation_indx1= (WN1(:,1) -SP1(:,2))./(SP1(:,1) + SP1(:,2));
modulation_indx1_sp = (SP1(:,1) -SP1(:,2))./(SP1(:,1) + SP1(:,2)); %spont running effect laser off
figure; hold on
