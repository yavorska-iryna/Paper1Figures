...
MI1_sp_rsL = (SP1L(rs1,1) -SP1(rs1,1))./(SP1L(rs1,1) + SP1(rs1,1)); %running
MI1_sp_fsL = (SP1L(fs1,1) -SP1(fs1,1))./(SP1L(fs1,1) + SP1(fs1,1)); %running
...
MI1L = (WN1L(:,1) -WN1(:,1))./(WN1L(:,1) + WN1(fs1,1)); %running fs
