...
load ('C:\Users\lab\Resilio Sync\Paper1Figures\code\colorblind_map.mat'); % use color blind friendly colors
...
meanMI_sound = nanmean( nanmean([MI_sound_run MI_sound_sit],2));
semMI_sound = nansem( nanmean([MI_sound_run MI_sound_sit],2));
