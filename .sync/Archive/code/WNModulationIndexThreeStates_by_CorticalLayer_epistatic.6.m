...
cells_stats = readtable(CellsQualityStats)
for cc =1:length(data)
    if data(cc).dir<30
        ...
        if meanSpikeCount > 2 && CellsQualityStats.SNR(cc)>.5 && CellsQualityStats.uQ(2,cc)>10 
        ...
        try
            ...
            if data(cc).width < 0.7 && data(cc).endslope<0 || data(cc).width<0.3
                fs(cc) = 1;
            else
                Rs(cc) = 1;
            end
