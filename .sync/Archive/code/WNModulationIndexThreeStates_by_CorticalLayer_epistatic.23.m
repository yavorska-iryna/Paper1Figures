...
modulation_indx1_sp= (SP1L(:,1) -SP1L(:,4))./(SP1L(:,1) + SP1L(:,4)); 
...
plot([nanmean(modulation_indx1_sp) nanmean(modulation_indx1_sp)], [0 max(ylim)], 'r-')
plot([nanmedian(modulation_indx1_sp) nanmedian(modulation_indx1_sp)], [0 max(ylim)], 'c-')
title('spont');
subplot(1,2,2);
