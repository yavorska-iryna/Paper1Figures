...
figure(3); hold on
bar([1 2], [nanmean(modulation_indx1_sp) nanmean(modulation_indx1_evoked)], 'BarWidth', .4)
xticks([1:2])
xticklabels({'spont', 'evoked (response-sp)'})
ylabel('Modulation Index (mean/SEM)')
errorbar( [1 2], [nanmean(modulation_indx1_sp) nanmean(modulation_indx1_evoked)],  ...
    [sem(modulation_indx1_sp) sem(modulation_indx1)])
title('Effects of running on spont and evoked activity')
