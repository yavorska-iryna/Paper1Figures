...
MI_sound_sit = (WN1(rs1,1) - SP1(rs1,1))./ (WN1(rs1,1) +SP1(rs1,1));
MI_sound_run = (WN1(rs1,2) - SP1(rs1,2))./ (WN1(rs1,2) +SP1(rs1,2));

MI_sound_sitL = (WN1L(rs1,1) - SP1L(rs1,1))./ (WN1L(rs1,1) +SP1L(rs1,1));
MI_sound_runL = (WN1L(rs1,2) - SP1L(rs1,2))./ (WN1L(rs1,2) +SP1L(rs1,2));
