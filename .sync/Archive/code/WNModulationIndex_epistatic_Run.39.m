...
for cl = 1:length(CL)
    ...
    rs_cl(cl,1) = sum(~isnan(modulation_indx1(rs2))); % number of regular spiking cells in this layer
    fs_cl(cl,1) = sum(~isnan(modulation_indx1(fs2))); % number of fast spiking cells in this layer
    ...
    semMI1_spaserL_fs(cl) = sem(modulation_indx1_spLaser(fs2));
