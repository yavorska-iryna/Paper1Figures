...
EvokedWN = WN1;
modulation_indx1_evoked = (EvokedWN(:,1) - EvokedWN(:,2))./(EvokedWN(:,1) + EvokedWN(:,2));
...
for cl = 1:length(CL)
    ...
    meanMI1_fs(cl) = nanmean(modulation_indx1(fs1));
    meanMI2_fs(cl) = nanmean(modulation_indx2(fs1));
    semMI1_fs(cl) = sem(modulation_indx1(fs1));
    semMI2_fs(cl) = sem(modulation_indx2(fs1));
    meanMI1_rs(cl) = nanmean(modulation_indx1(rs1));
    meanMI2_rs(cl) = nanmean(modulation_indx2(rs1));
    semMI1_rs(cl) = sem(modulation_indx1(rs1));
    semMI2_rs(cl) = sem(modulation_indx2(rs1));
    
    rs_cl(cl,1) = sum(~isnan(modulation_indx1(rs1)));
    fs_cl(cl,1) = sum(~isnan(modulation_indx1(fs1)));
    rs_cl(cl,2) = sum(~isnan(modulation_indx2(rs1)));
    fs_cl(cl,2) = sum(~isnan(modulation_indx2(fs1)));
    ...
    meanMI2_fsL(cl) = nanmean(modulation_indx2L(fs1));
    semMI1_fsL(cl) = sem(modulation_indx1L(fs1));
    semMI2_fsL(cl) = sem(modulation_indx2L(fs1));
    meanMI1_rsL(cl) = nanmean(modulation_indx1L(rs1));
    meanMI2_rsL(cl) = nanmean(modulation_indx2L(rs1));
    semMI1_rsL(cl) = sem(modulation_indx1L(rs1));
    semMI2_rsL(cl) = sem(modulation_indx2L(rs1));
    ...
    rs_sp_cl(cl,2) = sum(~isnan(modulation_indx2_sp(rs1)));
    fs_sp_cl(cl,2) = sum(~isnan(modulation_indx2_sp(fs1)));
    
    meanMI1_spL_fs(cl) = nanmean(modulation_indx1_spL(fs1));
    meanMI2_sp_fs(cl) = nanmean(modulation_indx2_sp(fs1));
    meanMI2_spL_fs(cl) = nanmean(modulation_indx2_spL(fs1));
    semMI1_sp_fs(cl) = sem(modulation_indx1_sp(fs1));
    semMI2_sp_fs(cl) = sem(modulation_indx2_sp(fs1));
    semMI1_spL_fs(cl) = sem(modulation_indx1_spL(fs1));
    semMI2_spL_fs(cl) = sem(modulation_indx2_spL(fs1));
    
    meanMI1_sp_rs(cl) = nanmean(modulation_indx1_sp(rs1));
    meanMI1_spL_rs(cl) = nanmean(modulation_indx1_spL(rs1));
    meanMI2_sp_rs(cl) = nanmean(modulation_indx2_sp(rs1));
    meanMI2_spL_rs(cl) = nanmean(modulation_indx2_spL(rs1));
    semMI1_sp_rs(cl) = sem(modulation_indx1_sp(rs1));
    semMI2_sp_rs(cl) = sem(modulation_indx2_sp(rs1));
    semMI1_spL_rs(cl) = sem(modulation_indx1_spL(rs1));
    semMI2_spL_rs(cl) = sem(modulation_indx2_spL(rs1));
