...
for cl = 1:length(CL)
    ...
    % % spont activity
    modulation_indx1_sp = (SP1(indx,1) -SP1(indx,2))./(SP1(indx,1) + SP1(indx,2)); %spont running effect laser off
    modulation_indx1_spL = (SP1L(indx,1) -SP1L(indx,2))./(SP1L(indx,1) + SP1L(indx,2)); %spont running effect laser on
    
    modulation_indx1_spLaser = (nanmean(SP1L(indx,:),2) - nanmean(SP1(indx,:),2))./(nanmean(SP1L(indx,:),2) + nanmean(SP1(indx,:),2)); %effects of laser in sitting
...
figure; hold on
plot(modulation_indx1(rs1), modulation_indx1_sp(rs1), 'k.')
plot(modulation_indx1(fs1), modulation_indx1_sp(fs1), 'b.')
...
title_str = sprintf('laser effect, p = %d', p);
title(title_str);
