...
title(title_string)
subplot(2,1,2)
plot(SP1, SP1_laser, 'ko')
xlabel('running MI'); ylabel('VIP MI')
[r, p] = corr(SP1,SP1_laser, 'Type','Spearman','Rows', 'complete');
