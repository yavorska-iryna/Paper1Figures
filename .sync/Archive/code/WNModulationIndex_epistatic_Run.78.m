...
MI_sound_run = (WN1(rs1,1) - SP1(rs1,1))./ (WN1(rs1,1) +SP1(rs1,1));
MI_sound_sit = (WN1(rs1,2) - SP1(rs1,2))./ (WN1(rs1,2) +SP1(rs1,2));
[h,x] = hist(MI_sound_sit, [-1:.2:1]);
figure; hold on
plot(x,h);
[h,x] = hist(MI_sound_run, [-1:.2:1]);
plot(x,h);
